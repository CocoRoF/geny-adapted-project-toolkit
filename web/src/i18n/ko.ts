...
export const ko: Record<keyof typeof en, string> = {
  ...
  "deploy.stack.overrides.hint": "비워두거나 \"inherit\" 로 두면 저장된 값을 그대로 사용합니다. 사용자 스택이 공개 도메인의 TLS 만 듣는 자체 nginx/traefik 를 앞에 두고 있다면 HTTPS + 검증 건너뛰기 + Host 재작성을 함께 사용하세요.",
  "deploy.dismiss": "닫기",
