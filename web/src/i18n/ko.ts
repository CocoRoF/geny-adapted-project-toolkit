...
export const ko: Record<keyof typeof en, string> = {
  ...
  "chat.attach.error.encode_failed": "인코딩 실패",
  "chat.attach.error.max_total": "이미지는 한 번에 최대 {max}장까지 첨부할 수 있어요",
  "chat.attach.error.partial": "처음 {count}장만 첨부했어요 (최대 {max}장)",
  "chat.attach.error.read_failed": "파일을 읽지 못했습니다",
  "chat.attach.error.too_large": "MB — 이미지당 최대 5MB입니다",
  "chat.attach.error.unsupported_type": "PNG/JPEG/GIF/WebP만 첨부할 수 있어요",
  "chat.budget.advice": ". 새 세션을 시작하거나 Settings 에서 한도를 조정하세요.",
  "chat.budget.cap_label": " / 한도 ",
  "chat.budget.confirm": "확인",
  "chat.budget.spent_label": "누적 비용",
  "chat.budget.title": "이 세션의 예산 한도에 도달했습니다.",
  "chat.takeover.body":
    "다른 PC / 탭에서 시작한 invoke 가 아직 끝나지 않았어요. 이어받으면 진행 중인 작업을 중단하고 이 메시지로 다음 turn 을 진행합니다.",
  "chat.takeover.cancel": "취소",
  "chat.takeover.confirm": "강제로 이어받기",
  "chat.takeover.pending": "이어받는 중…",
  "chat.takeover.title": "다른 곳에서 작업이 진행 중입니다.",
  "env_editor.empty": "감지된 .env 파일이 없습니다. 파일 트리에서 직접 추가하세요.",
  "env_editor.header": "워크스페이스의 .env / .env.example 파일",
  "env_editor.loading": "불러오는 중…",
  "env_editor.no_example_to_pair": "이 위치에 짝지을 .env.example 파일이 없습니다.",
  "env_editor.open_in_editor": "Editor 에서 열기: {path}",
  "env_editor.seed_from_example": "예제({example})에서 채워서 {path} 생성/덮어쓰기",
  "env_settings.subdomain.snippet.cname_comment": "← 또는 기존 {domain} 의 target 과 동일",
  "env_settings.subdomain.snippet.env_comment": "# GAPT 서버 환경변수",
  "env_settings.subdomain.snippet.tunnel_comment":
    "# ~/.cloudflared/config.yml — ingress 에 와일드카드 항목 추가",
  "git.candidate.desc_after":
    " 으로 git 추적을 시작하거나, 프로젝트 페이지에서 원격 URL 을 추가하세요.",
  "git.candidate.desc_before":
    "이 레포는 원격 URL 없이 등록돼서 git 추적이 비활성화돼 있어요. 터미널에서 ",
  "git.candidate.title": "'{name}' 은(는) 빈 폴더 레포예요",
  "git.empty_project.add_repo": "레포 추가",
  "git.empty_project.desc_after": "로 git URL 을 등록하거나, URL 없이 빈 폴더만 만들 수도 있어요.",
  "git.empty_project.desc_before":
    '이 프로젝트는 빈 상태입니다. 프로젝트 페이지의 "레포지토리" 섹션에서 ',
  "git.empty_project.go_to_project": "프로젝트 페이지로 이동 →",
  "git.empty_project.title": "레포지토리가 없어요",
  "git.not_cloned.clone_now": "지금 클론하기",
  "git.not_cloned.cloning": "클론 중…",
  "git.not_cloned.desc":
    "프로젝트에 새로 추가된 레포지토리는 자동 클론이 안 되어 있을 수 있어요. 아래 버튼으로 지금 바로 가져올 수 있습니다.",
  "git.not_cloned.or_new_workspace": "또는 프로젝트 페이지에서 새 워크스페이스 만들기 →",
  "git.not_cloned.title": "이 레포는 아직 워크스페이스에 없어요",
  "git.rehydrate.empty": "빈 프로젝트 — 클론할 레포가 없어요",
  "git.rehydrate.failed": "재클론 실패: {detail}",
  "git.rehydrate.ready": "워크스페이스에 레포가 준비됐어요 ({outcome})",
  "git.repo_selector.empty_suffix": "(빈 폴더)",
  "git.repo_selector.title": "이 패널이 들여다볼 레포지토리를 바꿉니다",
  "ide_ws.auto_detection_applied": "자동 감지 적용됨",
  "ide_ws.detection_applied": "감지 결과를 적용했습니다.",
  "lightbox.view_larger": "{name} 크게 보기",
  "new_project.checkbox_hint": "(git 없는 폴더 + 나중에 레포 추가)",
  "new_project.checkbox_label": "빈 프로젝트로 시작",
  "new_project.empty_banner_desc":
    '— git 레포 없이 워크스페이스만 만들어요. 생성 후 프로젝트 페이지의 "레포지토리" 섹션에서 여러 git URL 을 자유롭게 추가할 수 있습니다.',
  "new_project.empty_banner_label": "빈 프로젝트 모드",
  "new_project.empty_title": "빈 프로젝트 만들기",
  "new_ws.branch_label": "브랜치",
  "new_ws.branches_load_failed": "브랜치 자동 불러오기 실패 — 직접 입력하세요.",
  "new_ws.cancel": "취소",
  "new_ws.create": "워크스페이스 만들기",
  "new_ws.creating": "만드는 중…",
  "new_ws.default_branch_label": "원격 기본 브랜치:",
  "new_ws.description":
    "이름을 정하고, 이 워크스페이스에 함께 클론할 레포지토리 + 각각의 브랜치를 고르세요.",
  "new_ws.deselect_all": "전체 해제",
  "new_ws.empty_folder_badge": "빈 폴더 · git 없음",
  "new_ws.name_hint": "이 프로젝트 안에서만 유니크하면 OK — 예: ws-1430, feature-test",
  "new_ws.name_label": "워크스페이스 이름",
  "new_ws.name_required": "워크스페이스 이름을 입력해주세요",
  "new_ws.no_remote_body_prefix":
    "이 레포는 원격 URL이 없어서 클론하지 않고 빈 폴더만 만듭니다. 워크스페이스 안 터미널에서",
  "new_ws.no_remote_body_suffix": "으로 시작할 수 있어요.",
  "new_ws.no_repos_body":
    "워크스페이스가 빈 폴더만 가집니다. 프로젝트 페이지에서 레포를 추가하면 다음 워크스페이스부터 포함할 수 있어요.",
  "new_ws.no_repos_title": "이 프로젝트에는 레포가 없어요",
  "new_ws.refresh_branches_title": "원격에서 브랜치 목록 다시 불러오기",
  "new_ws.repo_count_suffix": "· {count}개 레포",
  "new_ws.repos_heading": "포함할 레포지토리",
  "new_ws.repos_loading": "레포지토리 불러오는 중…",
  "new_ws.root": "루트",
  "new_ws.select_all": "전체 선택",
  "new_ws.title": "새 워크스페이스 만들기",
  "new_ws.worktree_hint": "비워두면 /workspace/<slug>/<id> 로 자동 생성",
  "new_ws.worktree_label": "워크트리 경로 (선택)",
  "project_detail.add": "추가",
  "project_detail.add_repo": "레포 추가",
  "project_detail.add_repo.required": "subpath + 표시 이름은 필수입니다.",
  "project_detail.cancel": "취소",
  "project_detail.display_name_label": "표시 이름",
  "project_detail.empty_branch": "(빈)",
  "project_detail.empty_repos.after":
    "버튼으로 git URL 을 등록하거나, 비워둔 채로 추가해서 빈 폴더로만 시작할 수도 있습니다.",
  "project_detail.empty_repos.before": "이 프로젝트에는 레포지토리가 없습니다. 위의",
  "project_detail.git_url_hint": "(비워두면 빈 폴더)",
  "project_detail.no_remote": "(no remote — git init 대기)",
  "project_detail.refreshing": "갱신 중…",
  "project_detail.remove_repo": "레포지토리 제거",
  "project_detail.remove_repo.confirm":
    "'{name}' 레포지토리를 제거할까요? (워크스페이스의 파일은 그대로 둠)",
  "project_detail.remove_repo.failed": "레포지토리 제거 실패: {msg}",
  "project_detail.repositories": "레포지토리",
  "project_detail.session_history": "세션 히스토리",
  "project_detail.subpath_label": "서브패스 (폴더명)",
  "projects.menu.empty.desc": "git 없이 시작 + 나중에 레포 추가 (VS Code 식 multi-root)",
  "projects.menu.empty.title": "빈 프로젝트",
  "projects.menu.import.desc": "기존 git 레포 URL 등록",
  "projects.menu.import.title": "불러오기",
  "projects.menu.scaffold.desc": "새 GitHub 레포 + 프리셋 스캐폴드",
  "projects.menu.scaffold.title": "새로 만들기",
  "projects.repo_count": "{count}개 레포지토리",
  "projects.repo_empty": "비어있음 (레포 없음)",
  "scaffold.cancel": "취소",
  "scaffold.confirm.hint":
    "아래 내용으로 GitHub 레포를 만들고 스캐폴드를 푸시한 뒤 GAPT 프로젝트로 등록합니다.",
  "scaffold.create": "만들기",
  "scaffold.creating": "만드는 중…",
  "scaffold.error.token_hint": "에서 GitHub PAT 등록 후 다시 시도.",
  "scaffold.field.display_name.hint": "한글 OK. 카드 + 프로젝트 페이지 상단에 표시됩니다.",
  "scaffold.field.display_name.label": "표시 이름",
  "scaffold.field.repo_name.error": "영숫자 + - _ . 만 (시작은 영숫자/_)",
  "scaffold.field.repo_name.hint":
    "GAPT 가 이 이름으로 새 레포를 만듭니다. 슬러그와 달라도 됩니다.",
  "scaffold.field.repo_name.label": "GitHub 레포 이름",
  "scaffold.field.slug.error": "소문자/숫자/하이픈만 사용 가능",
  "scaffold.field.slug.hint": "소문자, 숫자, 하이픈만. 표시 이름에서 자동 추출됩니다.",
  "scaffold.field.slug.label": "슬러그 (GAPT 내부 식별자)",
  "scaffold.field.visibility.label": "공개 범위",
  "scaffold.field.visibility.private": "private (권장)",
  "scaffold.next": "다음",
  "scaffold.options.hint": "{name} — 옵션을 조정합니다. 기본값으로 두면 바로 다음 단계로.",
  "scaffold.presets_load_failed": "프리셋 로드 실패:",
  "scaffold.presets_loading": "프리셋 불러오는 중…",
  "scaffold.prev": "이전",
  "scaffold.step.confirm": "확인 + 생성",
  "scaffold.step.identity": "식별 정보",
  "scaffold.step.options": "옵션",
  "scaffold.step.preset": "프리셋 선택",
  "scaffold.summary.display_name": "표시 이름",
  "scaffold.summary.options": "옵션",
  "scaffold.summary.preset": "프리셋",
  "scaffold.summary.repo": "GitHub 레포",
  "scaffold.summary.slug": "GAPT 슬러그",
  "scaffold.title": "새 프로젝트 만들기 — {step}",
  "scaffold.toggle.off": "미사용",
  "scaffold.toggle.on": "사용",
  "services.port_drift_tip":
    "선언 포트 :{port}가 사용 중이라 서버가 :{autoPort}로 옮겨갔어요. Expose는 감지된 포트를 사용합니다.",
  "test_panel.command_placeholder": "예: pytest, npm test, vitest run -t auth",
  "test_panel.detected_command": "감지된 명령:",
  "test_panel.empty_state": "테스트 명령을 입력하고 실행하세요.",
  "test_panel.press_run": "실행을 누르세요",
  "test_panel.run": "실행",
  "test_panel.starting": "{command} 시작 중…",
  "test_panel.stop": "중단",
  "test_panel.title": "테스트 러너",
  "trace.idle": "대기 중…",
  "trace.phase.api_request": "API 호출",
  "trace.phase.api_response": "API 응답",
  "trace.phase.context": "컨텍스트",
  "trace.phase.evaluate_complete": "평가 완료",
  "trace.phase.evaluate_start": "평가 시작",
  "trace.phase.guard": "가드",
  "trace.phase.input": "입력 정규화",
  "trace.phase.loop": "루프",
  "trace.phase.memory": "메모리",
  "trace.phase.parse": "파싱",
  "trace.phase.stage_bypass": "단계 건너뜀",
  "trace.phase.stage_enter": "단계 진입",
  "trace.phase.stage_exit": "단계 완료",
  "trace.phase.system": "시스템 프롬프트",
  "trace.phase.task_registry": "작업 레지스트리",
  "trace.phase.yield": "최종 결과",
  "wizard.apply": "이대로 적용",
  "wizard.basepath_desc_1": "이 앱은 GAPT path 기반 preview에서 동작하려면 빌드 시",
  "wizard.basepath_desc_2": "가 필요합니다. 워크스페이스 클론의",
  "wizard.basepath_desc_3": "와 Dockerfile만 수정합니다 (GitHub repo는 그대로).",
  "wizard.basepath_patched": "패치 적용:",
  "wizard.basepath_run": "패치 실행",
  "wizard.basepath_title": "🛠️ Next.js basePath 자동 패치",
  "wizard.confidence": "자신감 {percent}%",
  "wizard.description":
    "GAPT가 워크스페이스 내용을 살펴보고 dev 서버와 prod 배포 설정을 제안합니다.",
  "wizard.dev_enable": "시작하기",
  "wizard.dev_install_before": "dev 시작 전에 의존성 설치:",
  "wizard.dev_title": "개발 서버 (Dev)",
  "wizard.env_files_edit_hint":
    "IDE 파일 트리에서 직접 편집하세요. (다음 사이클에서 전용 패널 추가 예정)",
  "wizard.env_files_existing": "이미 있음:",
  "wizard.env_files_template": "템플릿:",
  "wizard.env_files_title": ".env 파일",
  "wizard.field_command": "명령",
  "wizard.field_compose_file": "compose 파일",
  "wizard.field_env_name": "환경 이름",
  "wizard.field_port": "포트",
  "wizard.field_primary_port": "primary 포트",
  "wizard.field_primary_service": "primary 서비스",
  "wizard.field_workdir": "작업 디렉토리",
  "wizard.footer_hint": "나중에 IDE → 개발 / 배포 탭에서 수정할 수 있습니다.",
  "wizard.kind_unknown": "프레임워크 미감지",
  "wizard.loading": "워크스페이스를 살펴보는 중…",
  "wizard.notes_summary": "무엇을 찾았는지 보기 ({count})",
  "wizard.prod_build_each": "매 배포마다 빌드 (`docker compose up --build`)",
  "wizard.prod_enable": "환경 생성",
  "wizard.prod_title": "프로덕션 환경 (Prod)",
  "wizard.skip": "건너뛰기",
  "wizard.sources": "출처: {sources}",
  "wizard.title": "프로젝트 자동 감지",
};
