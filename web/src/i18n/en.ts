...
export const en = {
  ...
  "env_editor.name": "Name",
  "env_editor.name_hint": "Unique within the project.",
  "env_editor.kind": "Target kind",
  "env_editor.kind.local": "Local Compose (docker compose on this host)",
  "env_editor.kind.remote_ssh": "Remote SSH (docker compose over SSH)",
  "env_editor.kind.webhook": "Webhook (POST a payload to an external URL)",
  "env_editor.kind.k8s": "Kubernetes (not supported in v1)",
  "env_editor.require_2fa": "Require 2FA",
  "env_editor.require_2fa_hint": "Deploy refuses without a valid code.",
  "env_editor.require_2fa.required": "Required",
  "env_editor.require_2fa.not_required": "Not required",
  "env_editor.cost_multiplier": "Cost multiplier",
  "env_editor.cost_multiplier_hint": "Affects cost reporting; usually 1.",
  "env_editor.inherit": "(inherit default)",
  "env_editor.section.compose": "Compose",
  "env_editor.section.presets": "Scenario presets — one click sets every field",
  ...
  "env_editor.strip_prefix": "Strip /preview/<slug> prefix",
  "env_editor.strip_prefix.on": "On (recommended for frontends without basePath)",
  "env_editor.strip_prefix.off": "Off (keep the prefix in the upstream request)",
  ...
  "env_editor.create.cancel": "Cancel",
  "env_editor.create.submit": "Create",
  "env_editor.create.submitting": "Creating…",
  "env_editor.error.field_count": "{n} field error(s):",
  ...
  // ── i18n sweep (2026-06-14): component Korean → keys ─
  "chat.attach.error.encode_failed": "encoding failed",
  "chat.attach.error.max_total": "You can attach at most {max} images at once",
  "chat.attach.error.partial": "Attached only the first {count} (max {max})",
  "chat.attach.error.read_failed": "could not read the file",
  "chat.attach.error.too_large": "MB — max 5MB per image",
  "chat.attach.error.unsupported_type": "only PNG/JPEG/GIF/WebP can be attached",
  "chat.budget.advice": ". Start a new session or adjust the limit in Settings.",
  "chat.budget.cap_label": " / limit ",
  "chat.budget.confirm": "OK",
  "chat.budget.spent_label": "Cumulative cost",
  "chat.budget.title": "This session has reached its budget limit.",
  "chat.takeover.body":
    "An invoke started on another PC / tab hasn't finished yet. Taking over interrupts the in-progress work and runs the next turn with this message.",
  "chat.takeover.cancel": "Cancel",
  "chat.takeover.confirm": "Force take over",
  "chat.takeover.pending": "Taking over…",
  "chat.takeover.title": "Work is in progress elsewhere.",
  "env_editor.empty": "No .env files detected. Add one directly from the file tree.",
  "env_editor.header": ".env / .env.example files in the workspace",
  "env_editor.loading": "Loading…",
  "env_editor.no_example_to_pair": "There is no .env.example file to pair at this location.",
  "env_editor.open_in_editor": "Open in Editor: {path}",
  "env_editor.seed_from_example": "Seed from example ({example}) to create/overwrite {path}",
  "env_settings.subdomain.snippet.cname_comment":
    "← or identical to the target of the existing {domain}",
  "env_settings.subdomain.snippet.env_comment": "# GAPT server environment variables",
  "env_settings.subdomain.snippet.tunnel_comment":
    "# ~/.cloudflared/config.yml — add a wildcard entry to ingress",
  "git.candidate.desc_after": " to start git tracking, or add a remote URL on the project page.",
  "git.candidate.desc_before":
    "This repo was registered without a remote URL, so git tracking is disabled. In the terminal, run ",
  "git.candidate.title": "'{name}' is an empty-folder repo",
  "git.empty_project.add_repo": "Add repository",
  "git.empty_project.desc_after":
    " to register a git URL, or create an empty folder without a URL.",
  "git.empty_project.desc_before":
    'This project is empty. In the "Repositories" section of the project page, use ',
  "git.empty_project.go_to_project": "Go to project page →",
  "git.empty_project.title": "No repositories yet",
  "git.not_cloned.clone_now": "Clone now",
  "git.not_cloned.cloning": "Cloning…",
  "git.not_cloned.desc":
    "Repositories added to the project after this workspace was created may not have been cloned automatically. Use the button below to fetch it now.",
  "git.not_cloned.or_new_workspace": "Or create a new workspace from the project page →",
  "git.not_cloned.title": "This repo isn't in the workspace yet",
  "git.rehydrate.empty": "Empty project — no repository to clone",
  "git.rehydrate.failed": "Re-clone failed: {detail}",
  "git.rehydrate.ready": "Repository is ready in the workspace ({outcome})",
  "git.repo_selector.empty_suffix": "(empty folder)",
  "git.repo_selector.title": "Switch which repository this panel inspects",
  "ide_ws.auto_detection_applied": "Auto-detection applied",
  "ide_ws.detection_applied": "Detection result applied.",
  "lightbox.view_larger": "View {name} larger",
  "new_project.checkbox_hint": "(folder without git + add repos later)",
  "new_project.checkbox_label": "Start as empty project",
  "new_project.empty_banner_desc":
    '— Creates just a workspace without a git repo. After creation, you can freely add multiple git URLs in the "Repositories" section of the project page.',
  "new_project.empty_banner_label": "Empty project mode",
  "new_project.empty_title": "Create empty project",
  "new_ws.branch_label": "Branch",
  "new_ws.branches_load_failed": "Failed to auto-load branches — enter one manually.",
  "new_ws.cancel": "Cancel",
  "new_ws.create": "Create workspace",
  "new_ws.creating": "Creating…",
  "new_ws.default_branch_label": "Remote default branch:",
  "new_ws.description":
    "Pick a name, then choose the repositories to clone together into this workspace plus the branch for each.",
  "new_ws.deselect_all": "Deselect all",
  "new_ws.empty_folder_badge": "Empty folder · no git",
  "new_ws.name_hint": "Just needs to be unique within this project — e.g. ws-1430, feature-test",
  "new_ws.name_label": "Workspace name",
  "new_ws.name_required": "Please enter a workspace name",
  "new_ws.no_remote_body_prefix":
    "This repo has no remote URL, so it is not cloned — only an empty folder is created. You can start from the terminal inside the workspace with",
  "new_ws.no_remote_body_suffix": ".",
  "new_ws.no_repos_body":
    "The workspace will only have an empty folder. Add a repo on the project page to include it from the next workspace onward.",
  "new_ws.no_repos_title": "This project has no repositories",
  "new_ws.refresh_branches_title": "Reload branch list from remote",
  "new_ws.repo_count_suffix": "· {count} repos",
  "new_ws.repos_heading": "Repositories to include",
  "new_ws.repos_loading": "Loading repositories…",
  "new_ws.root": "root",
  "new_ws.select_all": "Select all",
  "new_ws.title": "Create new workspace",
  "new_ws.worktree_hint": "Leave empty to auto-generate at /workspace/<slug>/<id>",
  "new_ws.worktree_label": "Worktree path (optional)",
  "project_detail.add": "Add",
  "project_detail.add_repo": "Add repo",
  "project_detail.add_repo.required": "subpath + display name are required.",
  "project_detail.cancel": "Cancel",
  "project_detail.display_name_label": "Display name",
  "project_detail.empty_branch": "(empty)",
  "project_detail.empty_repos.after":
    "button above to register a git URL, or add one with the URL blank to start with just an empty folder.",
  "project_detail.empty_repos.before": "This project has no repositories. Use the",
  "project_detail.git_url_hint": "(leave blank for an empty folder)",
  "project_detail.no_remote": "(no remote — awaiting git init)",
  "project_detail.refreshing": "Refreshing…",
  "project_detail.remove_repo": "Remove repository",
  "project_detail.remove_repo.confirm":
    "Remove the '{name}' repository? (Workspace files are left as-is.)",
  "project_detail.remove_repo.failed": "Failed to remove repository: {msg}",
  "project_detail.repositories": "Repositories",
  "project_detail.session_history": "Session history",
  "project_detail.subpath_label": "Subpath (folder name)",
  "projects.menu.empty.desc": "Start without git + add repos later (VS Code-style multi-root)",
  "projects.menu.empty.title": "Empty project",
  "projects.menu.import.desc": "Register an existing git repo URL",
  "projects.menu.import.title": "Import",
  "projects.menu.scaffold.desc": "New GitHub repo + preset scaffold",
  "projects.menu.scaffold.title": "Create new",
  "projects.repo_count": "{count} repositories",
  "projects.repo_empty": "Empty (no repos)",
  "scaffold.cancel": "Cancel",
  "scaffold.confirm.hint":
    "GAPT creates a GitHub repo with the details below, pushes the scaffold, then registers it as a GAPT project.",
  "scaffold.create": "Create",
  "scaffold.creating": "Creating…",
  "scaffold.error.token_hint": "register a GitHub PAT, then try again.",
  "scaffold.field.display_name.hint":
    "Korean OK. Shown on the card + at the top of the project page.",
  "scaffold.field.display_name.label": "Display name",
  "scaffold.field.repo_name.error": "Alphanumeric + - _ . only (must start with alphanumeric/_)",
  "scaffold.field.repo_name.hint":
    "GAPT creates a new repo with this name. It can differ from the slug.",
  "scaffold.field.repo_name.label": "GitHub repo name",
  "scaffold.field.slug.error": "Only lowercase letters / digits / hyphens allowed",
  "scaffold.field.slug.hint":
    "Lowercase letters, digits, and hyphens only. Auto-derived from the display name.",
  "scaffold.field.slug.label": "Slug (GAPT internal identifier)",
  "scaffold.field.visibility.label": "Visibility",
  "scaffold.field.visibility.private": "private (recommended)",
  "scaffold.next": "Next",
  "scaffold.options.hint":
    "{name} — adjust options. Leave the defaults to jump straight to the next step.",
  "scaffold.presets_load_failed": "Failed to load presets:",
  "scaffold.presets_loading": "Loading presets…",
  "scaffold.prev": "Back",
  "scaffold.step.confirm": "Confirm + create",
  "scaffold.step.identity": "Identity",
  "scaffold.step.options": "Options",
  "scaffold.step.preset": "Select preset",
  "scaffold.summary.display_name": "Display name",
  "scaffold.summary.options": "Options",
  "scaffold.summary.preset": "Preset",
  "scaffold.summary.repo": "GitHub repo",
  "scaffold.summary.slug": "GAPT slug",
  "scaffold.title": "Create new project — {step}",
  "scaffold.toggle.off": "Off",
  "scaffold.toggle.on": "On",
  "services.port_drift_tip":
    "Declared port :{port} was in use, so the server moved to :{autoPort}. Expose uses the detected port.",
  "test_panel.command_placeholder": "e.g. pytest, npm test, vitest run -t auth",
  "test_panel.detected_command": "Detected command:",
  "test_panel.empty_state": "Enter a test command and run it.",
  "test_panel.press_run": "Press Run",
  "test_panel.run": "Run",
  "test_panel.starting": "Starting {command}…",
  "test_panel.stop": "Stop",
  "test_panel.title": "Test runner",
  "trace.idle": "Waiting…",
  "trace.phase.api_request": "API request",
  "trace.phase.api_response": "API response",
  "trace.phase.context": "Context",
  "trace.phase.evaluate_complete": "Evaluation complete",
  "trace.phase.evaluate_start": "Evaluation started",
  "trace.phase.guard": "Guard",
  "trace.phase.input": "Input normalization",
  "trace.phase.loop": "Loop",
  "trace.phase.memory": "Memory",
  "trace.phase.parse": "Parsing",
  "trace.phase.stage_bypass": "Stage skipped",
  "trace.phase.stage_enter": "Entering stage",
  "trace.phase.stage_exit": "Stage complete",
  "trace.phase.system": "System prompt",
  "trace.phase.task_registry": "Task registry",
  "trace.phase.yield": "Final result",
  "wizard.apply": "Apply as-is",
  "wizard.basepath_desc_1": "For this app to work under GAPT path-based preview, it needs ",
  "wizard.basepath_desc_2": " at build time. It only modifies the workspace clone's ",
  "wizard.basepath_desc_3": " and Dockerfile (the GitHub repo stays untouched).",
  "wizard.basepath_patched": "Patch applied:",
  "wizard.basepath_run": "Run patch",
  "wizard.basepath_title": "🛠️ Next.js basePath auto-patch",
  "wizard.confidence": "Confidence {percent}%",
  "wizard.description":
    "GAPT inspects your workspace contents and suggests a dev server and prod deployment setup.",
  "wizard.dev_enable": "Start",
  "wizard.dev_install_before": "Install dependencies before starting dev:",
  "wizard.dev_title": "Dev server (Dev)",
  "wizard.env_files_edit_hint":
    "Edit them directly in the IDE file tree. (A dedicated panel is planned for the next cycle.)",
  "wizard.env_files_existing": "Already present:",
  "wizard.env_files_template": "Templates:",
  "wizard.env_files_title": ".env files",
  "wizard.field_command": "Command",
  "wizard.field_compose_file": "compose file",
  "wizard.field_env_name": "Environment name",
  "wizard.field_port": "Port",
  "wizard.field_primary_port": "primary port",
  "wizard.field_primary_service": "primary service",
  "wizard.field_workdir": "Working directory",
  "wizard.footer_hint": "You can edit this later in the IDE → Dev / Deploy tabs.",
  "wizard.kind_unknown": "Framework not detected",
  "wizard.loading": "Inspecting workspace…",
  "wizard.notes_summary": "See what was found ({count})",
  "wizard.prod_build_each": "Build on every deploy (`docker compose up --build`)",
  "wizard.prod_enable": "Create environment",
  "wizard.prod_title": "Production environment (Prod)",
  "wizard.skip": "Skip",
  "wizard.sources": "Sources: {sources}",
  "wizard.title": "Auto-detect project",
} as const;
