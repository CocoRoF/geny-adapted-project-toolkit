...
export const en = {
  ...
  "auth.login.email.hint": "First-time emails get an account automatically. No password.",
  ...
  "auth.login.passwordless_note": "Passwordless — accounts are created on first sign-in.",
